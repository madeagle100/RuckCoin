...
git clone https://github.com/ravenproject/ruckcoin
mkdir -p release
cd ruckcoin/depends
...
sudo find ${DISTNAME}/bin -type f -executable -exec ../ruckcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
sudo find ${DISTNAME}/lib -type f -exec ../ruckcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
cd ~/
sudo rm -rf win64
cp -rf ruckcoin/contrib/windeploy ~/sign/win64
cd ~/sign/win64/windeploy
mkdir unsigned
mv ~/ruckcoin/raven-*setup-unsigned.exe unsigned/
...
cd ~/
sudo rm -rf win32
cp -rf ruckcoin/contrib/windeploy ~/sign/win32
...
~/ruckcoin/contrib/macdeploy/extract-osx-sdk.sh
...
git clone https://github.com/ravenproject/ruckcoin
mkdir ~/ruckcoin/depends/SDKs
#transfer MacOSX10.11.sdk.tar.gz to the folder ruckcoin/depends/SDKs
cd ruckcoin/depends/SDKs && tar -xf MacOSX10.11.sdk.tar.gz 
