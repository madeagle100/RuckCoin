...
find ${DISTNAME}/bin -type f -executable -exec ../ruckcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../ruckcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/ruckcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/ruckcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
