...
The following applies to code changes to the RuckCoin project (and related
projects) and is not to be confused with overall RuckCoin
Network Protocol consensus changes.

Whether a pull request is merged into RuckCoin rests with the project merge
...
Patches that change RuckCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the RuckCoin consensus, it must have been
...
The RavenQT-SIG selects a release manager for each RuckCoin release.
