...
QList<RavenUnits::Unit> RavenUnits::availableUnits()
{
    ...
    unitlist.append(RUCK);
    unitlist.append(mRUCK);
    unitlist.append(uRUCK);
    return unitlist;
}
...
QString RavenUnits::name(int unit)
{
    switch(unit)
    {
    case RUCK: return QString("RUCK");
    case mRUCK: return QString("mRUCK");
    case uRUCK: return QString::fromUtf8("μRUCK");
...
QString RavenUnits::description(int unit)
{
    switch(unit)
    {
    case RUCK: return QString("Ravens");
    case mRUCK: return QString("Milli-Ravens (1 / 1" THIN_SP_UTF8 "000)");
    case uRUCK: return QString("Micro-Ravens (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 RavenUnits::factor(int unit)
{
    switch(unit)
    {
    case RUCK:  return 100000000;
    case mRUCK: return 100000;
    case uRUCK: return 100;
...
{
    return format(RUCK, amount / factorAsset(MAX_ASSET_UNITS - unit), plussign, separators, unit) + QString(" ") + customName;
}
