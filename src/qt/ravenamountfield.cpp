    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int h = lineEdit()->minimumSizeHint().height();
            	...
            	int w = fm.horizontalAdvance(RavenUnits::format(RavenUnits::RUCK, RavenUnits::maxMoney(), false, RavenUnits::separatorAlways, assetUnit));
			#else
				int w = fm.width(RavenUnits::format(RavenUnits::RUCK, RavenUnits::maxMoney(), false, RavenUnits::separatorAlways, assetUnit));
			#endif
