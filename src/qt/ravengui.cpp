...
std::array<CurrencyUnitDetails, 5> CurrencyUnits::CurrencyOptions = { {
    { "BTC",    "RUCKBTC"  , 1,          8},
    { "mBTC",   "RUCKBTC"  , 1000,       5},
    { "µBTC",   "RUCKBTC"  , 1000000,    2},
    { "Satoshi","RUCKBTC"  , 100000000,  0},
    { "USDT",   "RUCKUSDT" , 1,          5}
} };
...
void RavenGUI::createActions()
{
    ...
    transferAssetAction->setStatusTip(tr("Transfer assets to RUCK addresses"));
...
void RavenGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        if(IconsOnly) {
            ...
            labelToolbar->setPixmap(QPixmap::fromImage(QImage(":/icons/ruckcointext")));
        }
...
//        m_toolbar->addAction(votingAction);
        ...
        labelCurrentMarket->setText(tr("RuckCoin Market Price"));
        ...
        labelVersionUpdate->setText("<a href=\"https://github.com/RavenProject/RuckCoin/releases\">New Wallet Version Available</a>");
        ...
        // Get the latest RuckCoin release and let the user know if they are using the latest version
        // Network request code for the header widget
                       ...
                       if (key == "tag_name") {
                           ...
                           if (fNewSoftwareFound) {
                               ...
                               if (GetRandInt(2) == 1) {
                                   ...
                                   if (fRet) {
                                       QString link = "https://github.com/RavenProject/RuckCoin/releases";
...
void RavenGUI::checkAssets()
{
    ...
    if(AreAssetsDeployed()) {
        ...
        transferAssetAction->setToolTip(tr("Transfer assets to RUCK addresses"));
...
{
    versionRequest->setUrl(QUrl("https://api.github.com/repos/RavenProject/RuckCoin/releases"));
