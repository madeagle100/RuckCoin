...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        BOOST_CHECK(!IsAssetNameValid("RUCK", type));
        ...
        BOOST_CHECK(IsAssetNameValid("RUCKSPYDER", type));
        BOOST_CHECK(IsAssetNameValid("SPYDERRUCK", type));
        ...
        BOOST_CHECK(IsAssetNameValid("SERUCKOT", type));
