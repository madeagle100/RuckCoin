...
//    { "sendmany", 5 , "replaceable" },
    ...
    { "createassetauthaddress", 0, "nrequired" },
    { "createassetauthaddress", 1, "owner_assets" },
    { "addassetauthaddress", 0, "nrequired" },
    { "addassetauthaddress", 1, "owner_assets" },
    { "spendassetauth", 1, "outputs" },
    { "verifyassetauth", 1, "prevtxs" },
