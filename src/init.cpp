...
static boost::signals2::connection rpcNotifyBlockTipConnection;

void OnRPCStarted()
{
    rpcNotifyBlockTipConnection = uiInterface.NotifyBlockTip.connect(&RPCNotifyBlockChange);
}

void OnRPCStopped()
{
    rpcNotifyBlockTipConnection.disconnect();
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/madeagle100/RuckCoin>";
    const std::string URL_WEBSITE = "<https://github.com/madeagle100/RuckCoin>";
