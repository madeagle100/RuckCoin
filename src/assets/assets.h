...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAVEN_ASSET RUCKQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET RUCKO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET RUCKR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAVEN_ASSET RUCKT
