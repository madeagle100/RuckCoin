...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/ruck.conf are parsed in qt/raven.cpp's main()
    ...
    if (gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||  gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  ruckd [options]                      " + strprintf(_("Start %s Daemon"), _(PACKAGE_NAME)) + "\n";
...
#endif
            fprintf(stdout, "RuckCoin server starting\n");
