...
The RuckCoin Doxygen documentation can be generated by running `make docs` from the top-level 
...
be sent upstream but bugfixes may also be prudent to PR against RuckCoin so that they can be integrated
