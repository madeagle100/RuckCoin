...
class TxnMallTest(RavenTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 RUCK:
        ...
        # First: use raw transaction API to send 1240 RUCK to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RUCK coin each
        ...
        # Node0's balance should be starting balance, plus 50RUCK for another
        ...
        # Node0's total balance should be starting balance, plus 100RUCK for 
