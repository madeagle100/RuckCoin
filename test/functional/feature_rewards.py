...
class RewardsTest(RavenTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating RUCK for node[0] and activating assets...")
    ...
    # Basic functionality test - RUCK reward
    # - create the main owner address
    # - mine blocks to have enough RUCK for the reward payments, plus purchasing the asset
    ...
    # - distribute an RUCK reward amongst the shareholders
    # - verify that each one receives the expected amount of reward RUCK
    def basic_test_rvn(self):
        self.log.info("Running basic RUCK reward test!")
        n0, n1, n2 = self.nodes[0], self.nodes[1], self.nodes[2]
        ...
        self.log.info("Verifying RUCK holdings after payout")
    ...
    # - create the main owner address
    # - mine blocks to have enough RUCK for the reward fees, plus purchasing the asset
