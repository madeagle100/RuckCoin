...
class RawAssetTransactionsTest(RavenTestFramework):
    ...
    def atomic_swaps_test(self):
        ...
        # n1 buys 400 ANDUIN from n2 for 4000 RUCK
        price = 4000
        amount = 400
        fee = 0.01
        ...
        # n2 buys JAINA! from n1 for 20000 RUCK
        price = 20000
        amount = 1
